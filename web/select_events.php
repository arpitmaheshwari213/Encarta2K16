						...
						<div class="form-group">
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="code_marathon" onclick="total()" <?php if($row['code_marathon']) echo "checked" ?>> CODE MARATHON
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="insomnia" onclick="total()" <?php if($row['insomnia']) echo "checked" ?>>
									<input type="checkbox" value="1" name="insomnia" onclick="total()" <?php if($row['insomnia']) echo "checked" ?>> INSOMNIA
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="code_mutants" onclick="total()" <?php if($row['code_mutants']) echo "checked" ?>>
									<input type="checkbox" value="1" name="code_mutants" onclick="total()" <?php if($row['code_mutants']) echo "checked" ?>> CODE MUTANTS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="clean_the_bugs" onclick="total()" <?php if($row['clean_the_bugs']) echo "checked" ?>>
									<input type="checkbox" value="1" name="clean_the_bugs" onclick="total()" <?php if($row['clean_the_bugs']) echo "checked" ?>> CLEAN THE BUGS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="python_phreakers" onclick="total()" <?php if($row['python_phreakers']) echo "checked" ?>>
									<input type="checkbox" value="1" name="python_phreakers" onclick="total()" <?php if($row['python_phreakers']) echo "checked" ?>> PYTHON PHREAKERS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="klutzy_code" onclick="total()" <?php if($row['klutzy_code']) echo "checked" ?>>
									<input type="checkbox" value="1" name="klutzy_code" onclick="total()" <?php if($row['klutzy_code']) echo "checked" ?>> KLUTZY CODE
								</label>
							</div>
							<div class="checkbox" >
								<label>
									<input type="hidden" value="0" name="chaos" onclick="total()" <?php if($row['chaos']) echo "checked" ?>>
									<input type="checkbox" value="1" name="chaos" onclick="total()" <?php if($row['chaos']) echo "checked" ?>> CHAOS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="bragging" onclick="total()" <?php if($row['bragging']) echo "checked" ?>>
									<input type="checkbox" value="1" name="bragging" onclick="total()" <?php if($row['bragging']) echo "checked" ?>> BRAGGING
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="the_gauntlet" onclick="total()" <?php if($row['the_gauntlet']) echo "checked" ?>>
									<input type="checkbox" value="1" name="the_gauntlet" onclick="total()" <?php if($row['the_gauntlet']) echo "checked" ?>> THE GAUNTLET
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="bandit" onclick="total()" <?php if($row['bandit']) echo "checked" ?>>
									<input type="checkbox" value="1" name="bandit" onclick="total()" <?php if($row['bandit']) echo "checked" ?>> BANDIT
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="webcrats" onclick="total()" <?php if($row['webcrats']) echo "checked" ?>>
									<input type="checkbox" value="1" name="webcrats" onclick="total()" <?php if($row['webcrats']) echo "checked" ?>> WEBCRATS
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="euts" onclick="total()" <?php if($row['euts']) echo "checked" ?>> EVERYTHING UNDER THE SUN
								</label>
							</div>
							<div class="checkbox" >
								<label>
									<input type="hidden" value="0" name="head_rush" onclick="total()" <?php if($row['head_rush']) echo "checked" ?>>
									<input type="checkbox" value="1" name="head_rush" onclick="total()" <?php if($row['head_rush']) echo "checked" ?>> HEAD RUSH
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="digital_fortress" onclick="total()" <?php if($row['digital_fortress']) echo "checked" ?>>
									<input type="checkbox" value="1" name="digital_fortress" onclick="total()" <?php if($row['digital_fortress']) echo "checked" ?>> DIGITAL FORTRESS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="quiz_up" onclick="total()" <?php if($row['quiz_up']) echo "checked" ?>>
									<input type="checkbox" value="1" name="quiz_up" onclick="total()" <?php if($row['quiz_up']) echo "checked" ?>> QUIZ UP
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="accelera" onclick="total()" <?php if($row['accelera']) echo "checked" ?>> ACCELERA
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="youth_parliament" onclick="total()" <?php if($row['youth_parliament']) echo "checked" ?>>
									<input type="checkbox" value="1" name="youth_parliament" onclick="total()" <?php if($row['youth_parliament']) echo "checked" ?>> YOUTH PARLIAMENT
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="mad_about_ads" onclick="total()" <?php if($row['mad_about_ads']) echo "checked" ?>>
									<input type="checkbox" value="1" name="mad_about_ads" onclick="total()" <?php if($row['mad_about_ads']) echo "checked" ?>> MAD ABOUT ADS
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="art_design" onclick="total()" <?php if($row['art_design']) echo "checked" ?>>
									<input type="checkbox" value="1" name="art_design" onclick="total()" <?php if($row['art_design']) echo "checked" ?>> ART DESIGN
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="blue_print" onclick="total()" <?php if($row['blue_print']) echo "checked" ?>> BLUE PRINT
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="circuit_cipher" onclick="total()" <?php if($row['circuit_cipher']) echo "checked" ?>>
									<input type="checkbox" value="1" name="circuit_cipher" onclick="total()" <?php if($row['circuit_cipher']) echo "checked" ?>> CIRCUIT CIPHER
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="line_follower_race" onclick="total()" <?php if($row['line_follower_race']) echo "checked" ?>>
									<input type="checkbox" value="1" name="line_follower_race" onclick="total()" <?php if($row['line_follower_race']) echo "checked" ?>> LINE FOLLOWER RACE
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="open_hardware" onclick="total()" <?php if($row['open_hardware']) echo "checked" ?>>
									<input type="checkbox" value="1" name="open_hardware" onclick="total()" <?php if($row['open_hardware']) echo "checked" ?>> OPEN HARDWARE
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="open_software" onclick="total()" <?php if($row['open_software']) echo "checked" ?>>
									<input type="checkbox" value="1" name="open_software" onclick="total()" <?php if($row['open_software']) echo "checked" ?>> OPEN SOFTWARE
								</label>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="dalal_street" id="dalal_street" onclick="total()" <?php if($row['dalal_street']) echo "checked" ?>> DALAL STREET(Rs.50)
								</label>
							</div>
							<div class="checkbox">
								<label>
							...
							<div class="checkbox">
								<label>
									...
									<input type="checkbox" value="1" name="pick_a_pic" onclick="total()" <?php if($row['pick_a_pic']) echo "checked" ?>> PICK A PIC
								</label>
							</div>
						</div>
						<div class="form-group">
							GAMEZVILLA
							<h5>(get Rs30 off on all three games)</h5>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="counter_strike"  onclick="total()" <?php if($row['counter_strike']) echo "checked" ?>>
									<input type="checkbox" value="1" name="counter_strike" id="counter_strike" onclick="total()" <?php if($row['counter_strike']) echo "checked" ?>> COUNTER STRIKE(Rs.50)
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="need_for_speed" onclick="total()" <?php if($row['need_for_speed']) echo "checked" ?>>
									<input type="checkbox" value="1" name="need_for_speed" onclick="total()" <?php if($row['need_for_speed']) echo "checked" ?>> NEED FOR SPEED
								</label>
							</div>
							<div class="checkbox">
								<label>
									<input type="hidden" value="0" name="mini_militia"  onclick="total()" <?php if($row['mini_militia']) echo "checked" ?>>
									<input type="checkbox" value="1" name="mini_militia" id="mini_militia" onclick="total();" <?php if($row['mini_militia']) echo "checked" ?>> MINI MILITIA(Rs.30)
								</label>
							</div>
						</div>
						<button type="submit" class="btn btn-success btn-raised btn-lg" name="event_update" value="true">Submit</button>
